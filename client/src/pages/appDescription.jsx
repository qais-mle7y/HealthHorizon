...
const appDescription = `
   ...
   Disease Reporting: Users can report new cases of diseases, which are then added to the apps database and displayed on the heat map.
   Location Services:
